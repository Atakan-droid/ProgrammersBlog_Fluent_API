...
namespace Business.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        {
            var articles = await _unitOfWork.Articles.GetAllAsync(null, a => a.User, article => article.Category);
            if (articles.Count>-1)
            {
            ...
            return new DataResult<ArticleListDto>(ResultStatus.Error, "Böyle makaleler bulunamadı", null);
        }
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title} başlıklı makale veri tabanından silindi");
            }
            return new Result(ResultStatus.Error, "Böyle bir makale bulunamadı");
        }
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            article.ModifiedByName = modifiedByName;
            await _unitOfWork.Articles.UpdateAsync(article).ContinueWith(t => _unitOfWork.SaveAsync());
            return new Result(ResultStatus.Success, $"{articleUpdateDto.Title} isimli makale güncellenmiştir.");
        }
    }
}
